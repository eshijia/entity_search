...
if __name__ == '__main__':
    ...
    plt.plot(np.arange(1, len(target) + 1), np.asarray(target), 'g.-', markevery=10, label='Adam')
    plt.plot(np.arange(1, len(target2) + 1), np.asarray(target2), 'bo-', markevery=10, label='Adagrad')
    plt.plot(np.arange(1, len(target3) + 1), np.asarray(target3), 'rv-', markevery=10, label='SGD')
    plt.plot(np.arange(1, len(target4) + 1), np.asarray(target4), 'ys-', markevery=10, label='RMSprop')
    plt.plot(np.arange(1, len(target5) + 1), np.asarray(target5), 'k*-', markevery=10, label='Adadelta')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
