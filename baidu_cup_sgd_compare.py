...
if __name__ == '__main__':
    ...
    plt.scatter(np.arange(1, len(target) + 1)[::5], np.asarray(target)[::5], color='g', s=10)
    plt.scatter(np.arange(1, len(target2) + 1)[::5], np.asarray(target2)[::5], color='b', s=10)
    plt.scatter(np.arange(1, len(target3) + 1)[::5], np.asarray(target3)[::5], color='r', s=10)
    plt.scatter(np.arange(1, len(target4) + 1)[::5], np.asarray(target4)[::5], color='y', s=10)
    plt.scatter(np.arange(1, len(target5) + 1)[::5], np.asarray(target5)[::5], color='k', s=10)
