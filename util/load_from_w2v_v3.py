...
if __name__ == '__main__':
    ...
    vocab_celebrity = load(serialization_data_path, 'celebrity_vocabulary_v3.pkl')
    vocab_movie = load(serialization_data_path, 'movie_vocabulary_v3.pkl')
    vocab_restaurant = load(serialization_data_path, 'restaurant_vocabulary_v3.pkl')
    vocab_tvShow = load(serialization_data_path, 'tvShow_vocabulary_v3.pkl')
    weights = model.syn0
    ...
    np.save(open('../embeddings/celebrity_300_dim_v3.embeddings', 'wb'), emb_c)
    np.save(open('../embeddings/movie_300_dim_v3.embeddings', 'wb'), emb_m)
    np.save(open('../embeddings/restaurant_300_dim_v3.embeddings', 'wb'), emb_r)
    np.save(open('../embeddings/tvShow_300_dim_v3.embeddings', 'wb'), emb_t)
